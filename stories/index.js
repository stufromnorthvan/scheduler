...
storiesOf("Appointment", module)
  ...
  .add("Create", () => <Form student={""} interviewer={interviewer} interviewers={interviewers} onSave={action("onSave")}
  onCancel={action("onCancel")} onChange={action("setInterviewer")}/>)
  .add("Edit", () => <Form student={"Lydia Miller-Jones"} interviewer={2} interviewers={interviewers} onSave={action(`onSave`)}
  onCancel={action("onCancel")} onChange={action("setInterviewer")}/>)
